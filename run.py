...
if __name__ == "__main__":
    ...
    print("JACKAL_LASER:", os.environ.get("JACKAL_LASER"))
    print("JACKAL_LASER_MODEL:", os.environ.get("JACKAL_LASER_MODEL"))
    print("JACKAL_LASER_OFFSET:", os.environ.get("JACKAL_LASER_OFFSET"))
